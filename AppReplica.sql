...
where ffProductionOrder.ProductionOrderNumber in ('A40000748')
...
declare @ApplicatorOrderNumber varchar(50)='A40000748'
...
select  uu.*,po.ProductionOrderNumber,po.ActualFinishTime,snk.Value as KitPack, pok.ProductionOrderNumber from dbo.kaunitsapp  uu
